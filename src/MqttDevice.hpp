...
public:
  ...
  void on(const char *Topic, std::function<void(const char *topic, const char *payload)> call_back, bool useDeviceIdPrefix = true);
  void onJson(const char *Topic, std::function<void(const char *topic, const JsonDocument &doc)> call_back, bool useDeviceIdPrefix = true);
  void onBinary(const char *Topic, std::function<void(const char *topic, const uint8_t *payload, unsigned int length)> call_back, bool useDeviceIdPrefix = true);
